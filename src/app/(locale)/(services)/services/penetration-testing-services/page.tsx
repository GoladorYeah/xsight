...
export default function Page() {
    ...
    const t = useTranslations("Services.penetration-testing-services")
            ...
            <section className="relative overflow-hidden">
                <div className="max-w-screen-lg px-3 py-16 md:py-24 mx-auto relative">
                    ...
                    <div className="flex flex-col gap-y-8">
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                ...
                                <ul className="list-disc text-gray-600 ml-4">
                                    ...
                                    <li> {t("content.content-2.list-4")}</li>
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                ...
                                <ul className="list-disc text-gray-600 ml-4">
                                    ...
                                    <li> {t("content.content-3.list-3")}</li>
                                    <li> {t("content.content-3.list-4")}</li>
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                ...
                                <ul className="list-disc text-gray-600 ml-4">
                                    ...
                                    <li> {t("content.content-4.list-3")}</li>
                                    <li> {t("content.content-4.list-4")}</li>
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                ...
                                <ul className="list-disc text-gray-600 ml-4">
                                    ...
                                    <li> {t("content.content-5.list-4")}</li>
                                    <li> {t("content.content-5.list-5")}</li>
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                ...
                                <ul className="list-disc text-gray-600 ml-4">
                                    ...
                                    <li> {t("content.content-6.list-3")}</li>
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                ...
                                <ul className="list-disc text-gray-600 ml-4">
                                    ...
                                    <li> {t("content.content-7.list-3")}</li>
                                    <li> {t("content.content-7.list-4")}</li>
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-y-2">
                            <h3 className="font-bold text-xl md:text-2xl text-balance mb-2">
                                {t("content.content-8.title")}
                            </h3>
                            <div className="border border-orange-500/50 mb-4 w-32"></div>
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                <h4 className="text-lg font-semibold">{t("result")}</h4>
                                <ul className="list-disc text-gray-600 ml-4">
                                    <li> {t("content.content-8.list-1")} </li>
                                    <li> {t("content.content-8.list-2")}</li>
                                    <li> {t("content.content-8.list-3")}</li>
                                </ul>
                            </div>

                            <div className="flex flex-col gap-y-2"
                                 dangerouslySetInnerHTML={{__html: t.raw("content.content-8.text")}}>

                            </div>
                        </div>
                        <div className="flex flex-col gap-y-2">
                            <h3 className="font-bold text-xl md:text-2xl text-balance mb-2">
                                {t("content.content-9.title")}
                            </h3>
                            <div className="border border-orange-500/50 mb-4 w-32"></div>
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                <h4 className="text-lg font-semibold">{t("result")}</h4>
                                <ul className="list-disc text-gray-600 ml-4">
                                    <li> {t("content.content-9.list-1")} </li>
                                    <li> {t("content.content-9.list-2")}</li>
                                    <li> {t("content.content-9.list-3")}</li>
                                    <li> {t("content.content-9.list-4")}</li>
                                    <li> {t("content.content-9.list-5")}</li>
                                </ul>
                            </div>

                            <div className="flex flex-col gap-y-2"
                                 dangerouslySetInnerHTML={{__html: t.raw("content.content-9.text")}}>

                            </div>
                        </div>
                        <div className="flex flex-col gap-y-2">
                            <h3 className="font-bold text-xl md:text-2xl text-balance mb-2">
                                {t("content.content-10.title")}
                            </h3>
                            <div className="border border-orange-500/50 mb-4 w-32"></div>
                            <div className="bg-gray-200/75 rounded-lg w-fit relative p-4">
                                <h4 className="text-lg font-semibold">{t("result")}</h4>
                                <ul className="list-disc text-gray-600 ml-4">
                                    <li> {t("content.content-10.list-1")} </li>
                                    <li> {t("content.content-10.list-2")}</li>
                                    <li> {t("content.content-10.list-3")}</li>
                                    <li> {t("content.content-10.list-4")}</li>
                                    <li> {t("content.content-10.list-5")}</li>
                                </ul>
                            </div>

                            <div className="flex flex-col gap-y-2"
                                 dangerouslySetInnerHTML={{__html: t.raw("content.content-10.text")}}>
